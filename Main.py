...
@client.event
async def on_ready():
  await client.change_presence(activity=discord.Game(name= "skivvi program" ))#change this if you want
  print(f''' 
...
\x1b[38;5;172mVersion: Premium v1.6
\x1b[38;5;172m═══════════════════════════
''')
...
async def nuke(ctx, amount=500):
  ...
  await ctx.guild.edit(name="Fucked By Ace")
